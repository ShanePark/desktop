...
/**
 * Attempt to detect and handle protocol handler arguments passed to a Linux
 * launch. Electron adds its own switches before the application URL, so only
 * non-option arguments after the executable path are candidates here.
 */
